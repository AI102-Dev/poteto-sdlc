...
| Skill | Answers |
|---|---|
| [`ai-native-sdlc`](skills/ai-native-sdlc/SKILL.md) | Which lifecycle stage are we in, what artifact does it produce, who signs off? First-principles, right-sized gates: Intent → Spike / Research → Spec → Guardrails → Plan & Build → Checks → QA → Deploy → Monitor → Outcome Review → Incident → Regression → Prevention. |
